                ...
                if (tabTaillePart[g] <= 0) {
                    ...
                    if (g == (nbPart - 1)) {
                        if (tabTaillePart[g] != (taille - ancien)) {
                            swal.fire("la taille de la derniére partiton doit étre égale à " + (taille - ancien) + " ko,veuillez la réintroduire:");
                        ...
                        if (tabTaillePart[g] >= taille - ancien) {
                            ...
                            swal.fire("la taille de la partiton " + g + " doit étre iférieure à " + (taille - ancien) + " ko, veuillez la réintroduire:");
