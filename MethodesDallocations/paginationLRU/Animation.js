...
/* la classe rectangle représente la creation d'un rectangle
 ...
 class CaseM
  ...
  class FifoPage
  {
      ...
      {
            this.fileh=new Rectangle(svgContainer,'transparent',x,y,rx,(width+padding)*nbCase-padding,heightP,610,360,textSize,textWeight,'white');
      ...
      etatFifo(text,delay)
      {
          this.fileb.changeText(text,delay);
      }
      cacherFifo(delay)
      {
